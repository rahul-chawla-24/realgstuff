...
class hashTable {
  ...
  hash(key) {
    let sum = 0;
    Array.from(key).forEach(i => (sum += i.charCodeAt(0)));
...
let hash = new hashTable(7);
hash.set("DS-and-Algo", "50");
hash.set("React", "42");
hash.set("JavaScript", "49");
hash.set("HTML-and-CSS", "40");
console.log("Checking Get function");
console.log("React : ", hash.get("React"));
console.log("javaScript :", hash.get("JavaScript"));
hash.delete("HTML-and-CSS");
